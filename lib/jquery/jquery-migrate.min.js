...
"undefined" == typeof jQuery.migrateMute && (jQuery.migrateMute = !0),
  (function (a, b) {
      ...
      (a.find = function (a) {
        ...
        if ("string" == typeof a && i.test(a))
          try {
            ...
            a = a.replace(j, function (_a, b, c, d) {
              return "[" + b + c + '"' + d + '"]';
            });
            try {
              document.querySelector(a),
    ...
    (a.fn.removeAttr = function (b) {
      var d = this;
      return (
        a.each(b.match(o), function (_b, e) {
    ...
    var p = !1;
    a.swap &&
      a.each(["height", "width", "reliableMarginRight"], function (_b, c) {
    ...
    (a.event.props = []),
      ...
      a.each(["load", "unload", "error"], function (_b, d) {
        a.fn[d] = function () {
